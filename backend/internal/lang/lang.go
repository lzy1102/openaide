...
var messages = map[Lang]map[string]string{
	ZH: {
		...
		"repl.plan_approval_title": "计划已生成，批准执行? (y/n, a=全部自动)",
		"repl.selected":            "已选择: %s",
		...
		"repl.help_compact":        "手动压缩会话上下文",
		"repl.help_tree":           "浏览项目文件",
		"repl.help_status":         "系统健康与提供商",
		"repl.help_undo":           "回滚到最后一个检查点",
		"repl.help_auto":           "切换自主（目标驱动）模式",
		"repl.help_research":       "切换并行研究子代理",
		"repl.help_init":           "为本项目生成 OPENAIDE.md",
		"repl.session_cleared":     "✓ 会话已清空",
		"repl.compact_failed":      "⚠ 压缩失败: %v",
		"repl.compact_nothing":     "无可压缩内容",
		"repl.compact_done":        "✓ 上下文已压缩: %d → %d tokens (-%d%%)",
		"repl.compact_unavailable": "⚠ 压缩不可用",
		"repl.generating_doc":      "生成 OPENAIDE.md…",
		"repl.lang_en":             "English",
		"repl.auto_on":             "✓ 自动批准已开启",
		"repl.auto_off":            "✓ 自动批准已关闭",
		"repl.research_on":         "✓ 并行研究已开启",
		"repl.research_off":        "✓ 并行研究已关闭",
		"repl.usage_team":          "用法: /team <任务>",
		"repl.usage_role":          "用法: %s <任务>",
		"repl.model_switched":      "✓ 模型: %s",
		"repl.tree_title":          "项目文件树:",
		"repl.status_title":        "系统状态:",
		"repl.status_active":       "当前: %s",
		"repl.sub_running":         "%s 执行中…",
		"repl.team_pipeline":       "团队: analyst → coder → reviewer",
		"repl.doc_generated":       "OPENAIDE.md 已生成 (%d 字符) — 将在后续会话加载",
		"repl.editor_err":          "✗ 编辑器: %v",
		"repl.interrupted":         "⚠ 已中断",
		"repl.cancelled":           "⚠ 已取消",
		"repl.history_search":      "历史搜索 (输入过滤):",
		"repl.gauge_tools":         "工具",
		"repl.gauge_round":         "轮次",
		"repl.gauge_elapsed":       "耗时",
		"repl.gauge_cache":         "缓存",
		"repl.resume_row":          "  %s%s: %s (%d 条消息)\n",
		"repl.sub_done":            "%s 完成",
		"repl.select_hint":         "↑↓ 移动 · enter 确认 · esc 取消",
		"repl.approval_timeout":    "审批超时，已自动拒绝",
	...
	EN: {
		...
		"repl.selecting":           "● selecting",
		"repl.searching":           "● searching",
		"repl.tools_running":       "⚙ tools",
		...
		"repl.plan_approval_title": "Plan generated, approve execution? (y/n, a=auto)",
		...
		"repl.task_progress":       "Task progress",
		...
		"repl.help_compact":        "manually compress session context",
		"repl.help_tree":           "browse project files",
		"repl.help_status":         "system health & providers",
		"repl.help_undo":           "rollback to last checkpoint",
		"repl.help_auto":           "toggle autonomous (goal-driven) mode",
		"repl.help_research":       "toggle parallel research sub-agents",
		"repl.help_init":           "generate OPENAIDE.md for this project",
		"repl.session_cleared":     "✓ session cleared",
		"repl.compact_failed":      "⚠ compact failed: %v",
		"repl.compact_nothing":     "nothing to compact",
		"repl.compact_done":        "✓ context compacted: %d → %d tokens (-%d%%)",
		"repl.compact_unavailable": "⚠ compact unavailable",
		"repl.generating_doc":      "generating OPENAIDE.md…",
		"repl.lang_en":             "English",
		"repl.auto_on":             "✓ auto-approve ON",
		"repl.auto_off":            "✓ auto-approve OFF",
		"repl.research_on":         "✓ parallel research ON",
		"repl.research_off":        "✓ parallel research OFF",
		"repl.usage_team":          "usage: /team <task>",
		"repl.usage_role":          "usage: %s <task>",
		"repl.model_switched":      "✓ Model: %s",
		"repl.tree_title":          "Project tree:",
		"repl.status_title":        "System status:",
		"repl.status_active":       "active: %s",
		"repl.sub_running":         "%s running…",
		"repl.team_pipeline":       "team: analyst → coder → reviewer",
		"repl.doc_generated":       "OPENAIDE.md generated (%d chars) — will be loaded in future sessions",
		"repl.editor_err":          "✗ editor: %v",
		"repl.interrupted":         "⚠ Interrupted",
		"repl.cancelled":           "⚠ Cancelled",
		"repl.history_search":      "History search (type to filter):",
		"repl.gauge_tools":         "tools",
		"repl.gauge_round":         "round",
		"repl.gauge_elapsed":       "elapsed",
		"repl.gauge_cache":         "cache",
		"repl.resume_row":          "  %s%s: %s (%d msgs)\n",
		"repl.sub_done":            "%s done",
		"repl.select_hint":         "↑↓ move · enter select · esc cancel",
		"repl.approval_timeout":    "Approval timed out, auto-rejected",
